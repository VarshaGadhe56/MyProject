...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CSE","IT","CIVIL","MECH","ELECTRICAL"};
	private String[] yearString = new String[] {"FE","SE","TE","BE"};
	private String[] subjectFEString = new String[] {"M1","M2","M3","M4","SC","MC","CC","ECOM","ITPM","DMDW","MIS","PERL","INS","WT"};
	
	private String[] subjectSEString = new String[] {"M1","M2","M3","M4","SC","MC","CC","ECOM","ITPM","DMDW","MIS","PERL","INS","WT"};
	private String[] subjectTEString = new String[] {"M1","M2","M3","M4","SC","MC","CC","ECOM","ITPM","DMDW","MIS","PERL","INS","WT"};
	private String[] subjectBEString = new String[] {"M1","M2","M3","M4","SC","MC","CC","ECOM","ITPM","DMDW","MIS","PERL","INS","WT"};

	private String[] subjectFinal = new String[] {"M1","M2","M3","M4","M3","DS","M4","CN","M5","NS","SC","MC","CC","ECOM","ITPM","DMDW","MIS","PERL","INS","WT"};
